...
const CartButton = ({ cartItemsCount, toggleCart }) => {
  ...
  return (
    <div
      className="flex justify-center items-center fixed bottom-10  z-10 bg-green-600 text-white rounded-full w-40 shadow-lg px-4 py-1 hover:bg-green-700 transition-all duration-700 cursor-pointer hover:shadow-xl"
      onClick={toggleCart}
    >
