  ...
  return (
    <Layout>
      ...
      <div
        ...
        style={{ height: `calc(110vh - ${navbarHeight}px - ${footerHeight}px)` }}
      >
        <Sidebar
          sidebarOpen={sidebarOpen}
          setSidebarOpen={setSidebarOpen}
        ...
        {sidebarOpen && (
          <div
            style={{ top: `${navbarHeight}px`, height: `calc(100vh - ${navbarHeight}px - ${footerHeight}px)` }}
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto bg-emerald-50">
          <div className="bg-white rounded-lg shadow p-6 h-full overflow-auto"> {/* White background for content area */}
            {/* <div>
